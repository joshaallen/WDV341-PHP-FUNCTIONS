        ...
        <div class="flexBox" id="flexBox-id">
            ...
            <main>
                ...
                <form id="form4" method="post"action="functions.php">
                    <label for="text4">4. Create a function that will accept a number and display it as a formatted number. Use 1234567890 for your testing.</label><input type="text" name="text4" id="text4"><input type="button" value="button4">
                </form>
                <form id="form5" method="post"action="functions.php">
                    <label for="text5">5. Create a function that will accept a number and display it as US currency. Use 123456 for your testing.</label><input type="text" name="text5" id="text5"><input type="button" value="button5">
                </form>
            </main> 
        </div><!--end of flex Box-->
